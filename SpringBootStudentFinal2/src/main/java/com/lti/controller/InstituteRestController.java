...
public class InstituteRestController {
	...
	public @ResponseBody int LoginInstitute(@PathVariable("instituteCode") int instituteCode,@PathVariable("setPassword") String setPassword) {
	...
	public @ResponseBody int  studentLogin(@PathVariable("aadharNo") long aadharNo,@PathVariable("password") String Password) {
